...
Item {
                ...
                NodeDelegate {
                    ...
                    function updateWindow() {
                        if(nodeDelegate.modelData.windowInfo)
                        {
                            ...
                            {
                                pos = nodeContainer.mapToGlobal(0, 0)
                            }

                            var rect = Qt.rect(pos.x, pos.y, width, height)
                            appCore.ipcClient.sendMessage(["MoveWindows", 1, modelData.windowInfo.hwnd, rect, visible])
                        }

                        childIncubator.item.updateWindows()
                    }
    ...
    Item {
        ...
        ColumnLayout {
            ...
            height: isSplit ? itemDelegate.height - verticalSplitItemSize : appCore.settingsContainer.headerSize * childCount
